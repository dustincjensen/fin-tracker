...
describe('utils', () => {
    describe('date', () => {
        ...
        describe('isInYear', () => {
            ...
            it('should return true when 2020-10-31 and 2020-01-01', () =>
                assertIsInYear('2020-10-31', '2020-01-01', true));
            it('should return true when 2020-12-31 and 2020-01-01', () =>
                assertIsInYear('2020-12-31', '2020-01-01', true));
            it('should return false when 2019-12-31 and 2020-01-01', () =>
                assertIsInYear('2019-12-31', '2020-01-01', false));
        });
        ...
        describe('formatDateFull', () => {
            ...
            // TODO moment deprecation warning
            it('should format "2020-06-16" as "June 16, 2020"', () =>
                assertFormatDateFull('2020-06-16', 'June 16, 2020'));
        ...
        describe('getMonthAndYearFromDate', () => {
            ...
            it('should return 0,2020 when provided 2020-01-15', () =>
                assertGetMonthAndYearFromDate('2020-01-15', [0, 2020]));
            it('should return 1,2020 when provided 2020-02-29', () =>
                assertGetMonthAndYearFromDate('2020-02-29', [1, 2020]));
            it('should return 1,2019 when provided 2019-02-28', () =>
                assertGetMonthAndYearFromDate('2019-02-28', [1, 2019]));
        ...
        describe('stringToMonthYear', () => {
            ...
            it('should return Feb 2020 when provided 2020-02-29', () =>
                assertStringToMonthYear('2020-02-29', 'Feb 2020'));
            it('should return Jan 2020 when provided 2020-01-01', () =>
                assertStringToMonthYear('2020-01-01', 'Jan 2020'));
            it('should return Dec 2020 when provided 2020-12-31', () =>
                assertStringToMonthYear('2020-12-31', 'Dec 2020'));
            it('should return Dec 2019 when provided 2019-12-31', () =>
                assertStringToMonthYear('2019-12-31', 'Dec 2019'));
        });
