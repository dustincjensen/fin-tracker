                ...
                {records.map(record => {
                    return (
                        <Table.Row key={record.id}>
                            ...
                            <Table.TextCell isNumber textAlign="right" {...cellDetails}>{record.debit}</Table.TextCell>
                            <Table.TextCell isNumber textAlign="right" {...cellDetails}>{record.credit}</Table.TextCell>
                            <Table.TextCell isNumber textAlign="right" {...cellDetails}>{record.balance}</Table.TextCell>
                        </Table.Row>
                    );
                })}
            </Table.Body>
