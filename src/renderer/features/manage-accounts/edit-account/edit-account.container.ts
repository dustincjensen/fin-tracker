...
type StateProps = Pick<IEditAccountProps, 'saveButtonText' | 'canEditComplexFields' | 'currentBalance' | 'lastTransactionDate'>;
...
const mapDispatchToProps = (dispatch: Dispatch): DispatchProps => ({
  ...
  archiveAccount: (id: string, archived: boolean, endYear: number, endMonth: number) => dispatch(AccountActions.archiveAccount(id, archived, endYear, endMonth)),
});
