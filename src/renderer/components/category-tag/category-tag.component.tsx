  ...
  return (
    <Pane display='inline-block'>
      ...
      >
        ...
        <Popover minWidth='unset' content={() => <Pane background='#474d66' minHeight='unset' paddingLeft='15px' paddingRight='15px' paddingBottom='10px' paddingTop='8px' textAlign='center'><Text color='white'>{category.name}</Text></Pane>}>
          <Text color='white' maxWidth='128px' overflow='hidden' textOverflow='ellipsis' paddingRight={onClear ? 10 : 5} onClick={close}>
            {category.name}
          </Text>
        </Popover>
